 ...
 */
final class Version20251009101914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conference (id INT NOT NULL, year VARCHAR(4) NOT NULL, international BOOLEAN NOT NULL, city VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
